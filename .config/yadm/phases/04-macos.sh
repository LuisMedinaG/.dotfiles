...
# Review each section and uncomment what you want. Run manually with:
...
sudo -v
# Keep sudo alive; cleanup function preserves the original script exit code.
...
# Disable the backswipe on trackpads
